...
const FoodLandingPage = () => {
  return (
    <div className="w-full min-h-screen bg-black font-sans text-white overflow-hidden">
  ...
  >
    ...
    >
      ...
      <section className="relative w-full bg-[#ef3a4b] px-6 py-10 md:px-16 lg:px-24 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex-1 flex justify-center absolute left-1/2 -translate-x-1/2 bottom-0 md:relative md:left-auto md:-translate-x-0 z-20">
      ...
      <div className="w-full lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 h-[800px] lg:h-full">
        
        {/* Top Left: Burger Combo */}
        <div className="bg-[#8b1c1c] p-8 flex flex-col justify-center relative overflow-hidden group">
        ...
        <div className="bg-[#111] p-8 flex flex-col justify-center relative overflow-hidden">
        ...
        <div 
          className="p-8 flex flex-col justify-between relative overflow-hidden bg-cover bg-center bg-no-repeat"
        ...
        <div 
          className="p-8 flex flex-col items-center justify-end relative overflow-hidden bg-cover bg-center bg-no-repeat"
